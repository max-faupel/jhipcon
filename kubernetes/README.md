...
```
$ docker image tag blog maximilianf/blog
$ docker push maximilianf/blog
$ docker image tag conference maximilianf/conference
$ docker push maximilianf/conference
$ docker image tag gateway maximilianf/gateway
$ docker push maximilianf/gateway
```
...
```
$ kubectl get svc gateway -n jhipcon
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n jhipcon
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n jhipcon
```
...
```
$ kubectl get svc jhipster-console -n jhipcon
```
...
```
$ kubectl expose service jhipster-registry --type=NodePort --name=exposed-registry -n jhipcon
```

and explore the details using

```
$ kubectl get svc exposed-registry -n jhipcon
```

For scaling the JHipster registry, use

```
$ kubectl scale statefulset jhipster-registry --replicas 3 -n jhipcon
```
